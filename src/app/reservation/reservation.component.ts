    ...
    timer(3000).subscribe(
      x => {
        if (this.listeVols_dispo == undefined) {
          ...
          this.message_erreur_details = VolsService.error_message;

        } else {
          // En cas de succes

          const nombre_vols = this.listeVols_dispo.length;
          this.message_statut = "STATUS: Success";
